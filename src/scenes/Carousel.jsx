...
import EmblaCarousel01 from '../components/carousel/EmblaCarousel01'

// css
import '../components/carousel/css/embla_dot.css'
import '../components/carousel/css/sandbox01.css'
...
const CarouselBG = ({autoSlide = false}) => {
  ...
  return (
    <div id='home' className="min-w-full lg:min-h-screen relative group snap-x snap-mandatory">
        ...
        <EmblaCarousel01 slides={SLIDES} options={OPTIONS} img={img} />
        </div>
