        ...
        <div class="">
          ...
          <span class="text-sm text-gray-500">incl. VAT plus shipping</span>
              ...
              <div class="mb-5 md:mb-7 flex items-center gap-2 text-gray-500">
                ...
                <span class="text-sm">{t("ship")}</span>
              </div>
              {/* <!-- shipping notice - end --> */}
              ...
              >
                ...
                <div className={`bg-magic-potion inline-flex w-full justify-between px-5 py-2  ${open ? 'rounded-t-lg' : 'rounded-lg transition-all delay-500'}`} onClick={toggle}>
                  <h2 className='text-alabaster font-semibold text-md'>{t("productDetails")}</h2>
                ...
                <Collapse isOpened={open} >
                  ...
                  <div className='grid grid-cols-4 px-5 py-7 gap-y-5'>
                    <div class="col-span-1 text-sm text-alabaster md:text-base">{t("material")}</div>
                    ...
                    <div class="col-span-1 text-sm text-alabaster md:text-base">{t("design")}</div>
                    <div class="col-span-3 flex flex-wrap gap-2">
                    {design.map((s, i) =>
                        <div class="group relative flex flex-row text-center text-tulip-yellow gap-2">
                    ...
                    <div className="col-span-1 text-sm text-alabaster md:text-base">{t("color")}</div>
                    ...
                    {color.map((s, i) =>
                      <div className="relative group">
                        ...
                        {console.log(colorCode[i])}
                      </div>
                    )}
                    </div>

                    <div class="col-span-1 text-sm text-alabaster md:text-base">{t("size")}</div>
                    <div class="col-span-3 flex flex-wrap gap-2">
                      {size.map((s, i) =>
                    ...
                    <div class="col-span-4 text-sm text-alabaster md:text-base">{t("productNote")}</div>
