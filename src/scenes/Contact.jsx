...
const Contact = ({contact, contactContent}) => {
    ...
    <div className='mt-36 px-5 md:px-10 py-10 bg-metalic-grey w-full rounded-lg'>
        ...
        >
            ...
            <form 
                ...
                method="POST"
            >
                <div className='flex flex-row justify-center md:flex-row md:space-x-3 font-montserrat'>
                    <input
                    ...
                    <button className='rounded border-2 border-magic-potion mb-3 md:rounded-none md:mb-0 md:rounded-r-lg bg-mettalic-gold px-8 py-1.5'>Submit</button>
                </div>
            </form>
        </motion.div>
